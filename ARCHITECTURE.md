...
- Lesson progress now counts the full route as `story blocks + summary + reflection + debate + quiz`; the lesson is completed only after the post-lesson quiz path can advance to the next lesson or complete the current lesson.
