import{B as K,D as j,H as U,a as $,d as P,h as q,k as H,l as i,m as W,n as u,p as o,q as k,r as z,t as G,u as x,v as L,w as M,x as w,y as T,z as B}from"./chunk-Y7IS6Y45.js";import{a as D}from"./chunk-UEKKBUIS.js";function X(){let e=i.currentLessonId?w(i.currentLessonId):x(i.currentEra)[0];return e?C(e).mood:""}function Pe(){let e=i.currentLessonId?w(i.currentLessonId):x(i.currentEra)[0];if(!e)return"";i.currentLessonEntryId!==e.id&&(i.currentLessonEntryId=e.id,i.currentLessonMode="intro",i.currentLessonStoryBlockIndex=0,i.currentPostStoryStep="reflection",i.currentLessonQuizChoice=null);let t=i.currentLessonId===e.id,a=C(e),r=z($[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),s=$e(e.title,e.detail,e.category,...e.related||[]),n=i.currentLessonMode==="intro";return`
  ...
  `}function oe(e,t={}){let a=se(e,t),r=re(i.currentLessonMode),s=f.indexOf(r),n=f.length;i.currentPostStoryStep=r;let l={reflection:A,assimilation:me,reality:ve,critical:ge,challenge:he,reward:ye,nextTeaser:fe}[r]||A;return`
  ...
  `}function re(e){let t=J[e]||e||i.currentPostStoryStep||"reflection";return f.includes(t)?t:"reflection"}function se(e,t={}){let a=C(e),r=v(e.title),s=L(e.id),n=M(e),c=T(e.eraKey,e.id);return{reflection:ie(e,t.insight,n),assimilation:ce(e,s,r,n),reality:le(e,r,n),critical:de(e,r,n),challenge:ue(e),reward:{kicker:"Artefacto desbloqueado",title:"Mem\xF3ria guardada",text:p(n.keyTakeaway||`Guardaste uma chave de leitura sobre ${r}.`,20),artifact:a.preview?.[0]||"Artefacto narrativo desbloqueado",previous:"challenge"},nextTeaser:{kicker:"Pr\xF3xima porta temporal",title:c?v(c.title):"Rever a jornada",text:c?p(pe(r,v(c.title)),20):"A viagem continua quando voltares ao mapa da era.",nextLessonId:c?.id||"",previous:"reward"}}}function E(e=""){let t=String(e||"").replace(/\s+/g," ").trim();return t?t.match(/[^.!?…]+(?:[.!?…]+["”’»]?|$)/g)?.map(a=>a.trim()).filter(Boolean)||[t]:[]}function Q(e=""){return String(e||"").trim().split(/\s+/).filter(Boolean).length}function p(e="",t=24){let a=E(e);if(!a.length)return"";let r=[],s=0;for(let n of a){let c=Q(n);if(r.length&&s+c>t||(r.push(n),s+=c,s>=t))break}return r.join(" ")}function ne(e,t){let a=E(e?.text);if(!a.length)return[e];let r=[],s=[],n=0;return a.forEach(c=>{let l=Q(c);s.length&&n+l>t&&(r.push(s.join(" ")),s=[],n=0),s.push(c),n+=l}),s.length&&r.push(s.join(" ")),r.map((c,l)=>({...e,id:`${e.id||"story"}-${l+1}`,text:c}))}function h(e){return L(e).flatMap(a=>ne(a,55))}function ie(e,t="",a={}){let r=v(e.title),s=u(r),n=a.reflection||(s.includes("fogo")?"O fogo nao mudou apenas a sobrevivencia. Mudou a forma como os humanos viviam juntos.":k(t||e.detail||V(e),150));return{kicker:"Pausa de assimila\xE7\xE3o",title:"O que isto mudou?",text:p(n,24),previous:"story"}}function ce(e,t,a,r={}){let s=[...r.evidence||[],...r.archaeology||[]],n=s.length?s.slice(0,2):t.slice(0,2).map(c=>c.text);return{kicker:"Guia hist\xF3rico",title:"O essencial",text:p(r.keyTakeaway||`${a} fica mais claro quando separas descoberta, escolha e consequencia.`,22),prompts:(n.length?n:["Que problema humano aparece aqui?","Que consequencia veio depois?"]).map(c=>p(c,14)),previous:"reflection"}}function le(e,t,a={}){let s=u(t).includes("fogo")?[["Energia","Hoje continuamos dependentes de energia para viver, trabalhar e comunicar."],["Tecnologia","Uma ferramenta simples pode reorganizar uma comunidade inteira."],["Seguranca","Proteger recursos importantes continua a ser uma decisao coletiva."]]:[["Tecnologia","Mudancas tecnicas alteram rotinas, trabalho e relacoes sociais."],["Comunidade","O que uma sociedade aprende muda a forma como coopera."],["Escolhas","Cada avancar tambem cria dependencias e novos custos."]];return{kicker:"Ponte ao presente",title:"Do passado para hoje",text:p(a.presentConnection||`${t} nao ficou preso ao passado. A mesma logica ainda aparece no presente.`,22),cards:s.slice(0,2).map(([n,c])=>[n,p(c,14)]),previous:"assimilation"}}function de(e,t,a={}){let s=u(t).includes("fogo")?"O dominio do fogo foi apenas progresso?":"Esta mudanca trouxe so beneficios?";return{kicker:"Lente cr\xEDtica",title:a.reflection||s,text:p(a.curiosity||"Olha para o mesmo momento por lentes diferentes.",20),perspectives:[["Sobrevivencia","Ajudou pessoas a resistir melhor ao mundo."],["Vida social","Mudou a forma como grupos se organizavam."],["Custo","Tambem criou novas pressoes sobre recursos e ambiente."]].slice(0,2).map(([n,c])=>[n,p(c,14)]),previous:"reality"}}function ue(e){let t=K(e.eraKey),a=t[j(e.eraKey,e.id)]||t[0];return{kicker:"Desafio",title:a?.question||"Que escolha ajudaria melhor o grupo?",quiz:a,previous:"critical"}}function pe(e,t){return`${e} abriu uma porta. A pr\xF3xima li\xE7\xE3o mostra o que mudou a seguir: ${t}.`}function O(e,t,a=""){let r=h(e.id).length,s=Math.max(1,r+f.length),n=Math.min(Math.max(t,0),s-1),c=s<=1?100:Math.round(n/(s-1)*100);return`
  ...
  `}function he(e,t,a,r){let s=e.quiz||{question:e.title,options:[],answer:0,explanation:""},n=i.currentLessonQuizChoice!==null,c=n&&i.currentLessonQuizChoice===s.answer;return`
