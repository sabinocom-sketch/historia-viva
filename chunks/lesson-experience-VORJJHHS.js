import{A as S,C as z,G as E,a as b,d as L,h as w,k as T,l as s,m as A,n as l,p as t,q as g,r as q,t as j,u as h,v,w as $,x as I,y as C}from"./chunk-WISMGPKQ.js";import{a as B}from"./chunk-UEKKBUIS.js";function O(){let e=s.currentLessonId?$(s.currentLessonId):h(s.currentEra)[0];return e?x(e).mood:""}function pe(){let e=s.currentLessonId?$(s.currentLessonId):h(s.currentEra)[0];if(!e)return"";let a=s.currentLessonId===e.id,o=x(e),r=q(b[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),n=re(e.title,e.detail,e.category,...e.related||[]),i=s.currentLessonMode==="intro";return`
