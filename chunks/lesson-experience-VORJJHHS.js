import{A as S,C as z,G as E,a as y,d as L,h as w,k as T,l as s,m as A,n as l,p as t,q as g,r as q,t as j,u as h,v,w as $,x as I,y as C}from"./chunk-WISMGPKQ.js";import{a as B}from"./chunk-UEKKBUIS.js";function O(){let e=s.currentLessonId?$(s.currentLessonId):h(s.currentEra)[0];return e?x(e).mood:""}function pe(){let e=s.currentLessonId?$(s.currentLessonId):h(s.currentEra)[0];if(!e)return"";let a=s.currentLessonId===e.id,o=x(e),r=q(y[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),n=re(e.title,e.detail,e.category,...e.related||[]),i=s.currentLessonMode==="intro";return`
  ...
  `}function R(e,a={}){if(s.currentLessonMode==="story"||s.currentLessonMode==="understand"){let o=v(e.id),r=k(o);return`
    ...
    `}return F(e,a)}function V(e,a,o,r={}){let n=e||{id:"story",visualType:"spark",backgroundMood:"cave-dark",text:"Um pequeno momento come\xE7ou a mudar a experi\xEAncia humana."},i=n.eraKey||r.eraKey||"",u=n.sectionId||r.sectionId||"";return`
    <article class="story-block" data-story-block="${t(n.id)}" data-visual="${t(n.visualType)}" data-background="${t(n.backgroundMood)}" data-mood="${t(O())}" data-era="${t(i)}" data-section="${t(u)}">
  ...
  `}function ee(e,a,o,r){let n=e.quiz||{question:e.title,options:[],answer:0,explanation:""},i=s.currentLessonQuizChoice!==null,u=i&&s.currentLessonQuizChoice===n.answer;return`
