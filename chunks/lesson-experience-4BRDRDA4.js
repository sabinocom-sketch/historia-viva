import{B as T,D as A,H as O,a as h,d as C,h as I,k as Q,l as i,m as E,n as u,p as t,q as b,r as q,t as R,u as f,v as y,w as S,x as $,y as P,z}from"./chunk-VNVLKROU.js";import{a as j}from"./chunk-UEKKBUIS.js";function F(){let e=i.currentLessonId?$(i.currentLessonId):f(i.currentEra)[0];return e?w(e).mood:""}function fe(){let e=i.currentLessonId?$(i.currentLessonId):f(i.currentEra)[0];if(!e)return"";i.currentLessonEntryId!==e.id&&(i.currentLessonEntryId=e.id,i.currentLessonMode="intro",i.currentLessonStoryBlockIndex=0,i.currentPostStoryStep="reflection",i.currentLessonQuizChoice=null);let a=i.currentLessonId===e.id,o=w(e),r=q(h[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),s=de(e.title,e.detail,e.category,...e.related||[]),n=i.currentLessonMode==="intro";return`
    <section class="active-lesson-panel lesson-view ${a?"is-active":""}" data-active-lesson="${t(e.id)}" data-era="${t(e.eraKey)}" data-section="${t(e.sectionId||"")}" data-mood="${t(o.mood)}" data-mode="${t(i.currentLessonMode)}" data-theme="${t(e.category)}">
      ...
      </div>`:N(e,{insight:s,curiosity:r})}
    </section>
  `}function N(e,a={}){if(i.currentLessonMode==="story"||i.currentLessonMode==="understand"){let o=y(e.id),r=L(o);return`
    ...
    `}return _(e,a)}function D(e,a,o,r={}){let s=e||{id:"story",visualType:"spark",backgroundMood:"cave-dark",text:"Um pequeno momento come\xE7ou a mudar a experi\xEAncia humana."},n=s.eraKey||r.eraKey||"",c=s.sectionId||r.sectionId||"",l=n==="pre-historia"||["paleolitico","mesolitico","revolucao-neolitica"].includes(c),d=l?G(s,r):"",g=l?H(s,r):"";return`
    <article class="story-block ${l?"storyblock-prehistory cave-firelight":""}" style="--cave-line-count: ${x(s.text).length}" data-story-block="${t(s.id)}" data-visual="${t(s.visualType)}" data-background="${t(s.backgroundMood)}" data-mood="${t(F())}" data-era="${t(n)}" data-section="${t(c)}" data-prehistory-artifact="${t(d)}">
      ...
      <div class="story-block-copy prehistory-stone-panel prehistory-cave-text-area prehistory-narrative-layout cave-pigment-reveal" style="--cave-line-count: ${x(s.text).length}">
      ...
      <div class="story-block-progress prehistory-progress" aria-label="Progresso dos story blocks">
        ${Array.from({length:o},(pe,B)=>`<span class="${B===a?"active":""}" aria-hidden="true"></span>`).join("")}
      </div>
  ...
  `}function ie(e,a,o,r){let s=e.quiz||{question:e.title,options:[],answer:0,explanation:""},n=i.currentLessonQuizChoice!==null,c=n&&i.currentLessonQuizChoice===s.answer;return`
