import{B as A,D as K,H as U,a as $,d as I,h as q,k as H,l as i,m as W,n as u,p as o,q as k,r as z,t as G,u as x,v as w,w as M,x as L,y as T,z as B}from"./chunk-4T6XYMQA.js";import{a as D}from"./chunk-UEKKBUIS.js";function X(){let e=i.currentLessonId?L(i.currentLessonId):x(i.currentEra)[0];return e?C(e).mood:""}function qe(){let e=i.currentLessonId?L(i.currentLessonId):x(i.currentEra)[0];if(!e)return"";i.currentLessonEntryId!==e.id&&(i.currentLessonEntryId=e.id,i.currentLessonMode="intro",i.currentLessonStoryBlockIndex=0,i.currentPostStoryStep="reflection",i.currentLessonQuizChoice=null);let t=i.currentLessonId===e.id,a=C(e),r=z($[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),s=ke(e.title,e.detail,e.category,...e.related||[]),n=i.currentLessonMode==="intro";return`
  ...
  `}function _(e,t={}){if(i.currentLessonMode==="story"||i.currentLessonMode==="understand"){let a=y(e.id),r=S(a);return`
    ...
    `}return oe(e,t)}function Y(e,t,a,r={}){let s=e||{id:"story",visualType:"spark",backgroundMood:"cave-dark",text:"Um pequeno momento come\xE7ou a mudar a experi\xEAncia humana."},n=s.eraKey||r.eraKey||"",c=s.sectionId||r.sectionId||"",l=n==="pre-historia"||["paleolitico","mesolitico","revolucao-neolitica"].includes(c),d=l?ee(s,r):"",h=l?Z(s,r):"",b=s.text,P=te(b),V=t===0?"eager":"lazy",N=t===0?"high":"auto";return`
    <article class="story-block ${l?"storyblock-prehistory cave-firelight":""}" style="--cave-line-count: ${P}" data-story-block="${o(s.id)}" data-story-index="${t%3}" data-visual="${o(s.visualType)}" data-background="${o(s.backgroundMood)}" data-mood="${o(X())}" data-era="${o(n)}" data-section="${o(c)}" data-prehistory-artifact="${o(d)}">
  ...
  `}function oe(e,t={}){let a=se(e,t),r=re(i.currentLessonMode),s=f.indexOf(r),n=f.length;i.currentPostStoryStep=r;let l={reflection:j,assimilation:ge,reality:ve,critical:ye,challenge:he,reward:fe,nextTeaser:be}[r]||j;return`
  ...
  `}function m(e,t,a){let r=y(a.id).length;return O(a,r+e,"post-story-progress")}function v(e,t="Continuar",a=!1){return`
