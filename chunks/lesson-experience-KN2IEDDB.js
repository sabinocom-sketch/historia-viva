import{G as Y,a as P,d as j,h as B,k as J,l as c,m as _,n as m,p as r,q as $,r as K,t as X,u as I,v as y,w as x,x as T,y as R,z as E}from"./chunk-KHE22BU5.js";import{a as W}from"./chunk-VR2J32YB.js";function ee(){let e=c.currentLessonId?T(c.currentLessonId):I(c.currentEra)[0];return e?Q(e).mood:""}function De(){let e=c.currentLessonId?T(c.currentLessonId):I(c.currentEra)[0];if(!e)return"";if(c.currentLessonEntryId!==e.id){c.currentLessonEntryId=e.id,c.currentLessonMode="intro",c.currentLessonStoryBlockIndex=0,c.currentPostStoryStep="summary";let i=de(e.id);c.currentLessonReflectionText=i.reflectionAnswer||"",c.currentLessonDebateChoice=i.debateChoice||"",c.currentLessonQuizAnswers=i.quizAnswers||{},c.currentPostLessonQuizIndex=0,c.currentLessonQuizChoice=null}let a=c.currentLessonId===e.id,t=Q(e),o=K(P[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),s=Me(e.title,e.detail,e.category,...e.related||[]),n=c.currentLessonMode==="intro";return`
