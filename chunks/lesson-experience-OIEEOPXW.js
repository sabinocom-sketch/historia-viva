import{B as T,D as A,H as N,a as h,d as C,h as I,k as O,l as i,m as V,n as u,p as t,q as f,r as S,t as F,u as b,v as y,w as q,x as $,y as P,z}from"./chunk-VNVLKROU.js";import{a as Q}from"./chunk-UEKKBUIS.js";function H(){let e=i.currentLessonId?$(i.currentLessonId):b(i.currentEra)[0];return e?L(e).mood:""}function we(){let e=i.currentLessonId?$(i.currentLessonId):b(i.currentEra)[0];if(!e)return"";i.currentLessonEntryId!==e.id&&(i.currentLessonEntryId=e.id,i.currentLessonMode="intro",i.currentLessonStoryBlockIndex=0,i.currentPostStoryStep="reflection",i.currentLessonQuizChoice=null);let a=i.currentLessonId===e.id,o=L(e),r=S(h[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),s=ye(e.title,e.detail,e.category,...e.related||[]),n=i.currentLessonMode==="intro";return`
    ...
    <article class="story-block ${l?"storyblock-prehistory cave-firelight":""}" style="--cave-line-count: ${w}" data-story-block="${t(s.id)}" data-story-index="${a%3}" data-visual="${t(s.visualType)}" data-background="${t(s.backgroundMood)}" data-mood="${t(H())}" data-era="${t(n)}" data-section="${t(c)}" data-prehistory-artifact="${t(d)}">
      ...
      <span class="story-block-visual cave-visual-artifact prehistory-artifact" aria-hidden="true">
        ${d==="flint"?`<picture class="prehistory-flint-picture">
          <source type="image/png" srcset="assets/silex-mobile.png?v=20260527 512w, assets/silex-desktop.png?v=20260527 1024w" sizes="(max-width: 768px) 70vw, min(34vw, 506px)" />
          <img class="prehistory-flint-sprite" src="assets/silex-desktop.png?v=20260527" alt="" width="1024" height="1024" loading="${j}" decoding="async" fetchpriority="${R}" />
        </picture>`:""}
      </span>
