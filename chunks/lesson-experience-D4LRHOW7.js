import{G as Y,a as P,d as j,h as B,k as J,l as c,m as _,n as m,p as r,q as $,r as K,t as X,u as I,v as y,w as x,x as T,y as R,z as E}from"./chunk-KHE22BU5.js";import{a as W}from"./chunk-VR2J32YB.js";function ee(){let e=c.currentLessonId?T(c.currentLessonId):I(c.currentEra)[0];return e?Q(e).mood:""}function De(){let e=c.currentLessonId?T(c.currentLessonId):I(c.currentEra)[0];if(!e)return"";if(c.currentLessonEntryId!==e.id){c.currentLessonEntryId=e.id,c.currentLessonMode="intro",c.currentLessonStoryBlockIndex=0,c.currentPostStoryStep="summary";let i=le(e.id);c.currentLessonReflectionText=i.reflectionAnswer||"",c.currentLessonDebateChoice=i.debateChoice||"",c.currentLessonQuizAnswers=i.quizAnswers||{},c.currentPostLessonQuizIndex=0,c.currentLessonQuizChoice=null}let a=c.currentLessonId===e.id,t=Q(e),o=K(P[e.eraKey].curiosities||[],e.index,"Cada vest\xEDgio hist\xF3rico muda quando fazemos uma pergunta melhor."),s=Me(e.title,e.detail,e.category,...e.related||[]),n=c.currentLessonMode==="intro";return`
  ...
  `}function ae(e,a={}){if(c.currentLessonMode==="story"||c.currentLessonMode==="understand"){let t=b(e.id),o=A(t);return`
    ...
    `}return ie(e,a)}function te(e,a,t,o={}){let s=e||{id:"story",visualType:"spark",backgroundMood:"cave-dark",text:"Um pequeno momento come\xE7ou a mudar a experi\xEAncia humana."},n=s.eraKey||o.eraKey||"",i=s.sectionId||o.sectionId||"",u=n==="pre-historia"||["paleolitico","mesolitico","revolucao-neolitica"].includes(i),d=u?se(s,o):"",p=u?oe(s,o):"",h=s.text,f=re(h),w=a===0?"eager":"lazy",S=a===0?"high":"auto";return`
    <article class="story-block ${u?"storyblock-prehistory cave-firelight":""}" style="--cave-line-count: ${f}" data-story-block="${r(s.id)}" data-story-index="${a%3}" data-visual="${r(s.visualType)}" data-background="${r(s.backgroundMood)}" data-mood="${r(ee())}" data-era="${r(n)}" data-section="${r(i)}" data-prehistory-artifact="${r(d)}">
      ...
      <span class="story-block-visual cave-visual-artifact prehistory-artifact" aria-hidden="true">
        ${d==="flint"?`<picture class="prehistory-flint-picture">
          ...
          <img class="prehistory-flint-sprite" src="assets/silex-desktop.png?v=20260528" alt="" width="1024" height="1024" loading="${w}" decoding="async" fetchpriority="${S}" />
        </picture>`:""}
      </span>
      <div class="story-block-copy prehistory-stone-panel prehistory-cave-text-area prehistory-narrative-layout cave-pigment-reveal" style="--cave-line-count: ${f}">
  ...
  `}function oe(e={},a={}){return g(a.title||e.title||"Marca na Pedra")}function se(e={},a={}){let t=m(`${a.title||""} ${e.text||""} ${e.visualType||""}`);return["fogo","chama","fogueira","aquecer","cozinhar","spark","embers"].some(o=>t.includes(o))?"fire":["caca","pesca","animal","rasto","lanca","spear","tracks"].some(o=>t.includes(o))?"hunt":["arte","rupestre","pintura","pigmento","mao","hand"].some(o=>t.includes(o))?"painting":["abrigo","gruta","caverna"].some(o=>t.includes(o))?"shelter":"flint"}function F(e=""){let a=String(e||"").trim();if(!a)return[""];let t=a.split(/(?<=[.!?])\s+|;\s+/).map(o=>o.trim()).filter(Boolean);return t.length?t:[a]}function re(e=""){return F(e).length}function ne(e=""){return`
  ...
  `}function ie(e,a={}){let t=ue(e,a),o=ce(c.currentLessonMode),s=k.indexOf(o),n=k.length;c.currentPostStoryStep=o;let u={summary:O,reflection:Ce,debate:Pe,quiz:Ie,reward:ze,nextTeaser:Ae}[o]||O;return`
  ...
  `}function ce(e){let a=Z[e]||e||c.currentPostStoryStep||"summary";return k.includes(a)?a:"summary"}function ue(e,a={}){let t=de(e,a),o=ye(e,a);return{summary:{summary:t.summary,previous:"story"},reflection:{...t.reflection,previous:"summary"},debate:{...t.debate,previous:"reflection"},quiz:{quiz:t.quiz,previous:"debate"},reward:o.reward,nextTeaser:o.nextTeaser}}function le(e=""){if(typeof localStorage>"u"||!e)return{};try{return JSON.parse(localStorage.getItem("historiaVivaProgress"))?.lessonProgress?.[e]||{}}catch{return{}}}function de(e,a={}){if(e.postLesson)return e.postLesson;let t=g(e.title),o=y(e.id),s=x(e),n=D(e,o,s);return{summary:n,reflection:{question:ge(s.reflection||a.insight||`Que mudan\xE7a hist\xF3rica te parece mais importante em ${t}?`)},debate:me(e,t,s),quiz:N(e,n)}}function D(e,a=[],t={}){let s=[t.keyTakeaway,...t.evidence||[],...t.archaeology||[],...t.consequences||[],...a.map(n=>n.text),e.detail].filter(Boolean).map(n=>pe(l(n,15),e)).filter(Boolean).filter((n,i,u)=>u.findIndex(d=>m(d)===m(n))===i).slice(0,4);for(;s.length<3;)s.push(l(`${g(e.title)} ajuda a perceber causas, escolhas humanas e consequ\xEAncias.`,14));return s.slice(0,4)}function pe(e="",a={}){if(!e||z(e)>=9)return e;let t=m(`${a.title||""} ${a.detail||""}`);return t.includes("pedra")||t.includes("ferramenta")?`${e} O gesto humano dava-lhe fun\xE7\xE3o e sentido.`:t.includes("fogo")?`${e} O uso repetido transformava seguran\xE7a, alimento e conv\xEDvio.`:`${e} O contexto hist\xF3rico ajuda a perceber a mudan\xE7a.`}function me(e,a,t={}){let o=l(t.keyTakeaway||e.detail||a,18);return{question:`Como devemos interpretar ${a}: sobretudo como progresso ou como mudan\xE7a complexa?`,options:[{id:"optionA",label:"Foi sobretudo progresso",feedback:`Esta posi\xE7\xE3o pode indicar que ${o.toLowerCase()} abriu possibilidades importantes. Ainda assim, muitos historiadores defendem que ganhos materiais tamb\xE9m trouxeram novos custos.`},{id:"optionB",label:"Foi uma mudan\xE7a complexa",feedback:`Esta posi\xE7\xE3o sugere que ${o.toLowerCase()} deve ser lido com cautela. H\xE1 debate sobre o peso dos benef\xEDcios e dos limites em diferentes grupos sociais.`}]}}function ge(e=""){let a=String(e).trim().replace(/[.?!]+$/,"");return a?`${a}?`:""}function N(e,a=[]){return he(e,a).slice(0,5)}function he(e={},a=[]){let t=g(e.title||"esta li\xE7\xE3o"),o=l(e.detail||a[0]||t,18),s=l(a[0]||e.detail||t,16),n=l(a[1]||e.question||e.detail||t,16),i=l(a[2]||"comparar vest\xEDgios, contexto e consequ\xEAncias",16);return[{question:`Qual \xE9 a ideia central da li\xE7\xE3o "${t}"?`,options:[s,"Foi um acontecimento isolado, sem rela\xE7\xE3o com o contexto.","Serve apenas para memorizar uma data, sem interpretar causas.","N\xE3o deixou pistas que possam ser estudadas historicamente."],correctIndex:0,explanation:`A resposta correta retoma diretamente o foco da li\xE7\xE3o "${t}".`},{question:`Que pista ajuda melhor a explicar "${t}"?`,options:[n,"Ignorar os grupos humanos envolvidos.","Separar o acontecimento das suas consequ\xEAncias.","Escolher uma resposta que podia servir para qualquer li\xE7\xE3o."],correctIndex:0,explanation:"A melhor pista nasce do conte\xFAdo trabalhado nesta li\xE7\xE3o, n\xE3o de outro tema da era."},{question:`Como devemos estudar historicamente "${t}"?`,options:[`Ligando ${i.toLowerCase()} ao contexto da li\xE7\xE3o.`,"Decorando uma frase sem analisar fontes ou consequ\xEAncias.","Trocando o tema por outro acontecimento da mesma era.","Assumindo que todos os grupos viveram a mudan\xE7a da mesma forma."],correctIndex:0,explanation:`Esta leitura mant\xE9m a resposta dentro da li\xE7\xE3o: ${o}`}].map(ve)}function ve(e={}){return{question:e.question||"Que ideia fica desta li\xE7\xE3o?",options:fe(e.options||[]),correctIndex:Number.isInteger(e.correctIndex)?e.correctIndex:Math.min(Math.max(e.answer||0,0),3),explanation:e.explanation||"Esta resposta enquadra melhor o contexto hist\xF3rico da li\xE7\xE3o."}}function fe(e=[]){let a=["Foi um processo sem contexto.","Aconteceu da mesma forma em todo o lado.","Teve apenas uma causa.","Deve ser lido com fontes e consequ\xEAncias."],t=e.slice(0,4);return a.forEach(o=>{t.length<4&&!t.includes(o)&&t.push(o)}),t.slice(0,4)}function ye(e,a={}){let t=Q(e),o=g(e.title),s=y(e.id),n=x(e),i=R(e.eraKey,e.id);return{reflection:$e(e,a.insight,n),assimilation:xe(e,s,o,n),reality:ke(e,o,n),critical:Le(e,o,n),challenge:qe(e),reward:{kicker:"Mem\xF3ria da cena",title:"Mem\xF3ria guardada",text:l(n.keyTakeaway||`Guardaste uma imagem mental sobre ${o}. Agora consegues lembrar o gesto e a consequ\xEAncia.`,20),artifact:t.preview?.[0]||"Artefacto narrativo desbloqueado",previous:"challenge"},nextTeaser:{kicker:"Pr\xF3xima cena",title:i?g(i.title):"Rever a jornada",text:i?l(we(o,g(i.title)),20):"A viagem continua quando voltares ao mapa da era.",nextLessonId:i?.id||"",previous:"reward"}}}function V(e=""){let a=String(e||"").replace(/\s+/g," ").trim();return a?a.match(/[^.!?…]+(?:[.!?…]+["”’»]?|$)/g)?.map(t=>t.trim()).filter(Boolean)||[a]:[]}function z(e=""){return String(e||"").trim().split(/\s+/).filter(Boolean).length}function l(e="",a=24){let t=V(e);if(!t.length)return"";let o=[],s=0;for(let n of t){let i=z(n);if(o.length&&s+i>a||(o.push(n),s+=i,s>=a))break}return o.join(" ")}function be(e,a){let t=V(e?.text);if(!t.length)return[e];let o=[],s=[],n=0;return t.forEach(i=>{let u=z(i);s.length&&n+u>a&&(o.push(s.join(" ")),s=[],n=0),s.push(i),n+=u}),s.length&&o.push(s.join(" ")),o.map((i,u)=>({...e,id:`${e.id||"story"}-${u+1}`,text:i}))}function b(e){return y(e).flatMap(t=>be(t,55))}function $e(e,a="",t={}){let o=g(e.title),s=L(e,o),n=s.reflectionText||t.reflection||$(a||e.detail||H(e),150);return{kicker:"Depois da cena",title:s.reflectionTitle||"O que ficou diferente?",text:l(n,24),previous:"story"}}function xe(e,a,t,o={}){let s=L(e,t),n=[...o.evidence||[],...o.archaeology||[]],i=s.prompts||(n.length?n.slice(0,2):a.slice(0,2).map(u=>u.text));return{kicker:"Guia da cena",title:s.assimilationTitle||"Seguir as pistas",text:l(s.assimilationText||o.keyTakeaway||`${t} ganha sentido quando vemos pessoas, objetos, escolhas e consequ\xEAncias.`,22),prompts:(i.length?i:["Que gesto humano aparece aqui?","Que consequ\xEAncia veio depois?"]).map(u=>l(u,14)),previous:"reflection"}}function ke(e,a,t={}){let o=L(e,a),s=o.realityCards||[["Gesto","Uma t\xE9cnica pequena podia mudar o que uma m\xE3o conseguia fazer."],["Presente","As ferramentas de hoje continuam a prolongar o corpo humano."]];return{kicker:"Ponte ao presente",title:o.realityTitle||"A marca no presente",text:l(o.realityText||t.presentConnection||`${a} ainda importa quando ajuda a perceber uma escolha humana reconhec\xEDvel.`,22),cards:s.slice(0,2).map(([n,i])=>[n,l(i,14)]),previous:"assimilation"}}function Le(e,a,t={}){let o=L(e,a);return{kicker:"Lente cr\xEDtica",title:o.criticalTitle||t.reflection||"Quem ganhou e quem perdeu?",text:l(o.criticalText||t.curiosity||"Uma boa leitura hist\xF3rica pergunta que possibilidades se abriram e que custos apareceram.",20),perspectives:(o.perspectives||[["Possibilidade","Algumas pessoas ganharam novas formas de agir."],["Limite","Outras enfrentaram riscos, sil\xEAncio ou depend\xEAncia."]]).slice(0,2).map(([s,n])=>[s,l(n,14)]),previous:"reality"}}function L(e={},a=""){let t=m(`${a} ${e.title||""} ${e.detail||""}`);return t.includes("fogo")?{reflectionTitle:"A noite mudou",reflectionText:"Quando a chama ficava acesa, a noite deixava de ser s\xF3 amea\xE7a. Havia calor, luz e rostos reunidos.",assimilationTitle:"Ler as cinzas",assimilationText:"Cinzas e ossos queimados n\xE3o falam sozinhos. Deixam pistas de cuidado repetido e de noites protegidas.",prompts:["Quem alimentava a fogueira quando todos tinham sono?","Que restos provariam que aquele fogo foi usado por humanos?"],realityTitle:"Ainda guardamos energia",realityText:"Hoje carregamos baterias; antes, algu\xE9m protegia brasas. A ideia continua pr\xF3xima: guardar energia para viver melhor.",realityCards:[["Luz","A energia ainda organiza trabalho, descanso e seguran\xE7a."],["Cuidado","Guardar uma fonte vital continua a exigir aten\xE7\xE3o coletiva."]],criticalTitle:"Quem ficava de vigia?",criticalText:"O fogo ajudava, mas tamb\xE9m exigia trabalho. Progresso quase nunca chega sem novas responsabilidades.",perspectives:[["Ganho","Mais calor, mais luz e alimento mais seguro."],["Custo","Era preciso vigiar, alimentar e proteger a chama."]]}:t.includes("ferramentas de pedra")||t.includes("pedra")?{reflectionTitle:"A m\xE3o ganhou alcance",reflectionText:"Depois do golpe certo, a pedra deixava de ser paisagem. Podia cortar, raspar e abrir novas possibilidades.",assimilationTitle:"Ler as lascas",assimilationText:"Uma lasca guarda escolhas: for\xE7a, \xE2ngulo e paci\xEAncia. Nela vemos t\xE9cnica, erro e aprendizagem.",prompts:["Que gesto humano ficou marcado na pedra?","O que uma lasca revela sobre quem aprendeu a talhar?"],realityTitle:"Ferramentas prolongam o corpo",realityText:"Do s\xEDlex ao computador, uma ferramenta faz a mesma pergunta: que limite do corpo queremos ultrapassar?",realityCards:[["Gesto","Uma t\xE9cnica pequena podia mudar o alcance da m\xE3o."],["Presente","As ferramentas de hoje continuam essa mesma ideia."]],criticalTitle:"Quem dominava a t\xE9cnica?",criticalText:"A ferramenta ajudava o grupo, mas o saber precisava de ser ensinado. Sem aprendizagem, a pedra voltava a ser s\xF3 pedra.",perspectives:[["Ganho","Cortar, raspar e fabricar ficou mais f\xE1cil."],["Risco","Um golpe errado podia destruir a pe\xE7a."]]}:{reflectionTitle:"O que ficou diferente?",reflectionText:$(e.detail||`${a} mudou a vida de pessoas concretas.`,140),assimilationTitle:"Seguir as pistas",assimilationText:`${a} ganha sentido quando vemos pessoas, objetos, escolhas e consequ\xEAncias.`,realityTitle:"A marca no presente",realityText:`${a} ainda importa quando ajuda a perceber uma escolha humana que continua reconhec\xEDvel.`,criticalTitle:"Quem ganhou e quem perdeu?",criticalText:"Uma boa leitura hist\xF3rica pergunta sempre que possibilidades se abriram e que custos apareceram.",perspectives:[["Possibilidade","Algumas pessoas ganharam novas formas de agir."],["Limite","Outras enfrentaram riscos, sil\xEAncio ou depend\xEAncia."]]}}function qe(e){let a=D(e,y(e.id),x(e)),t=Se(N(e,a)[0]);return{kicker:"Decis\xE3o r\xE1pida",title:t?.question||"Que escolha ajudaria melhor o grupo?",quiz:t,previous:"critical"}}function we(e,a){return`${e} abriu uma porta. A pr\xF3xima li\xE7\xE3o mostra o que mudou a seguir: ${a}.`}function Se(e={}){return{...e,answer:Number.isInteger(e.answer)?e.answer:e.correctIndex}}function G(e,a,t=""){let o=b(e.id).length,s=Math.max(1,o+k.length),n=Math.min(Math.max(a,0),s-1),i=s<=1?100:Math.round(n/(s-1)*100);return`
  ...
  `}function v(e,a,t){let o=b(t.id).length;return G(t,o+e,"post-story-progress")}function q(e,a="Continuar",t=!1){return`
  ...
  `}function O(e,a,t,o){let s=(e.summary||[]).slice(0,4);return`
    <article class="post-story-screen lesson-summary-screen" data-era="${r(a.eraKey||"")}" data-section="${r(a.sectionId||"")}" data-theme="${r(a.category)}">
      ...
      ${v(t,o,a)}
      ${q(e.previous,"Continuar")}
    </article>
  `}function Ce(e,a,t,o){return`
  ...
  `}function Pe(e,a,t,o){let s=(e.options||[]).find(n=>n.id===c.currentLessonDebateChoice);return`
  ...
  `}function Ie(e,a,t,o){let s=e.quiz||[],n=c.currentLessonQuizAnswers||{},i=s.reduce((M,C,U)=>M+(n[U]===C.correctIndex?1:0),0),u=s.filter((M,C)=>n[C]!==void 0).length,d=s.length>0&&u===s.length,p=d?Math.max(0,s.length-1):Math.min(Math.max(Number(c.currentPostLessonQuizIndex)||0,0),Math.max(0,s.length-1)),h=s[p],f=h&&n[p]!==void 0,w=p<s.length-1,S=!f&&!d?'<button type="button" disabled>Responde para continuar</button>':f&&!d&&w?'<button type="button" data-lesson-action="quiz-next">Pr\xF3xima pergunta</button>':`<button type="button" data-lesson-action="next" ${d?"":"disabled"}>Ver recompensa</button>`;return`
    <article class="post-story-screen challenge-screen quiz-screen ${d?"is-complete":""}" data-era="${r(a.eraKey||"")}" data-section="${r(a.sectionId||"")}" data-theme="${r(a.category)}" data-quiz-total="${s.length}">
      <span class="post-story-background" aria-hidden="true"></span>
      <div class="post-story-copy">
  ...
  `}function Te(e,a,t){let o=t!==void 0,s=o&&t===e.correctIndex;return`
  ...
  `}function ze(e,a,t,o){return`
    <article class="post-story-screen reward-screen" data-era="${r(a.eraKey||"")}" data-section="${r(a.sectionId||"")}" data-theme="${r(a.category)}">
      ...
      ${v(t,o,a)}
      ${q(e.previous,"Ver pr\xF3xima")}
    </article>
  `}function Ae(e,a,t,o){return`
