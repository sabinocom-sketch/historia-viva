...
- A orientacao final do silex usa `rotate(-25deg)` em desktop e mobile. A sombra do artefacto deve ser o filtro leve `drop-shadow(0 8px 12px rgba(0,0,0,.18))`, sem pseudo-elemento de contacto ativo para evitar duplicacao visual.
