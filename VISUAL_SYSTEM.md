...
- O titulo narrativo da Pre-Historia usa `"Amatic SC", cursive` com `font-weight: 700`; o corpo do texto pintado usa `"Patrick Hand", cursive` com `font-weight: 400`. Ambos usam `#4B2412`, `letter-spacing: 0.03em` e `text-shadow: 0 1px 1px rgba(255,220,160,.15)` como tratamento de pigmento principal. A etiqueta "Momento X de Y" nao aparece acima do titulo porque o progresso ja comunica a posicao no bloco.
