...
- A orientacao final do silex nao deve aplicar rotacao adicional por CSS (`rotate(0deg)` em desktop e mobile), preservando a silhueta do sprite original. A sombra de contacto vive no `::before` do artefacto como elipse curta, escura e desfocada, separada do sprite e da iluminacao geral para ajuste independente.
