...
- O titulo narrativo da Pre-Historia usa `"Amatic SC", cursive`, `font-weight: 700`, `font-size: clamp(2rem, 4vw, 4.5rem)`, `line-height: 0.95`, `letter-spacing: 0.04em`, textura `assets/textures/ochre-texture.webp` recortada no texto, `-webkit-text-stroke: 0.4px rgba(90,36,18,.35)`, sombra lateral subtil para dar massa de pigmento, `filter: brightness(1.08) saturate(1.08) contrast(1.14)` e `margin-top: 15px` para descer no fluxo sem comprimir o paragrafo. O corpo do texto pintado usa `"Patrick Hand", cursive`, `font-size: clamp(1rem, 1.25vw, 1.35rem)`, `line-height: 1.55`, uma unica cor quente de leitura `#E8D2A5` e `text-shadow: 0 1px 2px rgba(0,0,0,.35)`. As linhas reveladas dentro do paragrafo devem herdar esta cor, sem alternancias por linha. A etiqueta "Momento X de Y" nao aparece acima do titulo porque o progresso ja comunica a posicao no bloco.
